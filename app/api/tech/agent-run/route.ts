...
const bodySchema = z
  .object({
    ...
    */
    ...
    chiPhi: z.object({ soVong: z.number(), vao: z.number(), ra: z.number(), demDoc: z.number(), demGhi: z.number(), usd: z.number().nullable() }).nullable().optional(),
