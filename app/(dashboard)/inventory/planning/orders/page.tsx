...
export default async function ProductionOrdersPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader eyebrow="Kho" title="Bảng chốt đặt hàng sản xuất" description="Các bảng đã chốt theo mã (màu × size) để gửi xưởng may." hint="Tạo bảng mới từ trang Kế hoạch đặt hàng SX — nút quay lại nằm ngay bên phải tiêu đề này." actions={<Link href="/inventory/planning" className="text-sm font-medium text-primary hover:underline">← Kế hoạch đặt hàng</Link>} />
