 ...
 *
 * Đặc tả: `docs/creative-loop.md` §5f. Mỗi hàng một mẫu THẮNG / HỨA HẸN; hai ô = hai loại chiến dịch
    ...
    <SectionCard
      ...
      hint={
        <>
          ...
          xuất, chờ chủ shop chốt). Dựng hỏng giữa chừng thì bản sao vẫn TẮT và ô ghi rõ id để xoá tay. Đặc tả: <code>docs/creative-loop.md</code> §5f.
        </>
      }
      padded={false}
    >
