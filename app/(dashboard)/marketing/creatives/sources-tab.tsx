...
export async function SourcesTab({ params, canWrite }: { params: ListParams; canWrite: boolean }) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        {canWrite ? <SourceForm products={products} /> : null}
      </DataTableToolbar>
          ...
          <EmptyState
            ...
            description={
              counts.total
                ...
                : canWrite
                  ? "Bắt đầu bằng ẢNH SẢN PHẨM THẬT của các mã muốn test — không có ảnh loại này thì máy không dựng được lô nào. Ảnh đối thủ / R&D / tham khảo giúp máy học ý tưởng, nhưng chỉ được đọc thành mô tả chữ."
