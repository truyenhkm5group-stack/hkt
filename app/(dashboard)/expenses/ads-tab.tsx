  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
        <MetricCard label={`Tổng chi QC · ${period.label.toLowerCase()}`} value={formatVND(summary.spend, { compact: true })} goodWhen="down" change={change(summary.spend, prev?.spend)} note={`${formatNumber(summary.rows)} dòng · ${formatNumber(summary.leads)} tin nhắn/lead (Facebook báo) · không tính chiến dịch “Không tính”`} icon={Megaphone} tone="rose" />
        <MetricCard
