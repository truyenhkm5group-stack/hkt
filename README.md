...
| **Giao không thành · nhắn khách tự động** | Vận đơn Viettel Post giao thất bại trong 3 ngày gần nhất: chờ xử lý → nhắn Pancake hỏi lý do chưa nhận; hẹn phát lại → nhắn kèm tên & SĐT bưu tá đề nghị khách chủ động gọi hẹn giao lại. Mỗi vận đơn mở một case CSKH ghi rõ ✅ đã nhắn hoặc ⛔ chưa xử lý được (đơn từ landing page / sheet không có hội thoại) để gọi tay; case lên chuông và Lark. Mẫu tin chỉnh trong settings `cs.rules`. |
