...
| **Kết quả đơn (ORDER_OUTCOME)** | Dùng chung cho mọi báo cáo, **ưu tiên trạng thái vận đơn Viettel Post** trước trạng thái Pancake: vận đơn hoàn → hoàn; vận đơn đã giao → giao thành công (trừ quy tắc phát hiện hoàn); vận đơn đang đi → đang giao; chưa có trạng thái vận đơn mới xét theo Pancake. |
