...
| **Tỷ lệ hoàn theo mã hàng** | Tỷ lệ hoàn từng SKU theo quy tắc: vận đơn Viettel Post giao thành công chỉ là giao thật khi COD thu > 100.000đ; COD ≤ 100.000đ (khách không nhận, chỉ trả tiền ship / phí xem hàng; trừ đơn đã chuyển khoản trước) = đơn hoàn, áp dụng cho mọi báo cáo; bấm mã xem danh sách đơn; xuất CSV. |
