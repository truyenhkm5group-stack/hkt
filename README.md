...
| **Cần xử lý & thông báo** | Quét mỗi 10 phút và ngay sau webhook: đơn chờ xử lý quá N giờ, vận đơn giao thất bại chờ phát lại, vận đơn treo không cập nhật N ngày, đang chuyển hoàn → chuông thông báo trên mọi trang, trang “Cần xử lý” lọc theo loại, gửi Telegram cho nhóm vận đơn; mỗi vấn đề báo một lần, tự đóng khi đã xử lý. |
