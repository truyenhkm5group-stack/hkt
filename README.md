...
| **Chăm sóc khách băn khoăn & bán chéo** | Lập danh sách mỗi sáng (08:30) và theo yêu cầu: (1) khách đã nhắn Pancake trong 2 ngày nhưng chưa có đơn → tin hỏi thăm băn khoăn; (2) khách nhận hàng thành công 3–14 ngày → tin cảm ơn kèm gợi ý mã phối cùng (bảng gợi ý theo mã đã mua hoặc top bán chạy khách chưa mua). Mẫu tin có biến `{ten} {san_pham} {goi_y} {shop} {uu_dai}`, xem trước, sửa từng tin, tích chọn gửi hàng loạt qua inbox Pancake (giới hạn tin/ngày, không nhắn lại cùng khách trong 14 ngày); khách không có hội thoại → xuất CSV nhắn Zalo/SMS. |
