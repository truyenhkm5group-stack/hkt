...
| **Đối soát COD** | Chưa thu → đã thu → ĐVVC đã đối soát → đã về ngân hàng → chênh lệch; tạo đợt nhận tiền, đánh dấu hàng loạt, xuất CSV. **Bảng kê Viettel Post**: dán bảng “Tiền hàng đã trả” (mã bảng kê · ngày đối soát · tiền COD · cước/dư nợ · tiền thu về) hoặc tải file chi tiết một bảng kê → ghép vận đơn, đánh dấu đã về ngân hàng, ghi cước thực tế; số thu về đi thẳng vào báo cáo Dòng tiền thực. |
...
| **CSKH** | Case đổi size / đổi màu / sai địa chỉ / sai SĐT / trả hàng / khiếu nại: tự phát hiện từ thẻ đơn, ghi chú đơn và phiếu đổi trả Pancake (từ khoá chỉnh được), hoặc nhập tay; trạng thái, người phụ trách, kết quả xử lý; mở nhanh đơn và hội thoại Pancake. |
