...
| **Quảng cáo** (`/ads`) — hiệu suất theo Marketer & mã hàng | Module riêng: KPI chi QC / đơn xác nhận / ROAS / CPO, bảng xếp hạng marketer và mã hàng theo chi QC, tin nhắn, đơn đã xác nhận (chia theo ad_id → fanpage → tiền QC → chủ mã, phần không gắn được ở “Chưa gán marketer” nên tổng khớp đơn xác nhận), CPO, doanh số GTC ước tính, ROAS, LN sau QC = LN ròng ước tính (đã trừ mọi chi phí), tỷ lệ hoàn thực tế & dự kiến; kèm ngưỡng thanh toán tài khoản QC, biểu đồ chi tiêu, ghép chiến dịch → mã / marketer; đánh giá Tốt / Trung bình / Kém so với ROAS trung bình shop (cùng số liệu với Báo cáo lợi nhuận và Lương). |
