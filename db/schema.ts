...
export const adsDecisionLedger = pgTable(
  "ads_decision_ledger",
  {
    ...
    /*
      ─── Company OS · Agent F · ẢNH CHỤP DỰ PHÓNG (migration 0133) ───
      ...
      NULLABLE và KHÔNG BACKFILL (mục 35, 8.8): dòng ghi trước 0133 mang `NULL` = CHƯA CHỤP, không
    ...
    */
    ...
    /** Tỷ lệ GTC (%) đã áp cho phần đang treo của dòng. `NULL` = không có gì treo, hoặc dòng ghi trước 0133. */
