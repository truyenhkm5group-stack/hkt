...
export const notifications = pgTable(
  "notifications",
  {
    ...
    /**
     * GỬI LẠI TIN HỎNG (0145 · Company OS · Agent N — `lib/constants/notification-retry.ts`).
     * Số lần job `alerts` đã NHẬN gửi dòng này (kể cả lần đầu). `NULL` = chưa từng thử — dòng cũ trước
     * 0145, hoặc dòng không có kênh nào để gửi; những dòng đó KHÔNG BAO GIỜ được gửi lại.
     */
