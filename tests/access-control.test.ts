...
const CO_Y_CONG_KHAI: Record<string, string> = {
  ...
  "app/api/webhooks/pancake-chat/[secret]/route.ts": "webhook hội thoại Pancake, xác thực bằng bí mật trong đường dẫn; bí mật RỖNG ⇒ trả 401 (đóng, không phải mở toang)",
