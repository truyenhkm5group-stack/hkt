...
--> statement-breakpoint
ALTER TABLE "shipment_events" ADD COLUMN "normalized_stage" "shipment_stage";--> statement-breakpoint
ALTER TABLE "shipment_events" ADD COLUMN "leg_type" text;--> statement-breakpoint
ALTER TABLE "shipment_events" ADD COLUMN "verification_status" text;--> statement-breakpoint
ALTER TABLE "shipment_events" ADD COLUMN "source_reference" text;--> statement-breakpoint
ALTER TABLE "shipment_events" ADD COLUMN "verified_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "shipment_events" ADD COLUMN "verified_by" text;--> statement-breakpoint
ALTER TABLE "payment_evidence" ADD CONSTRAINT "payment_evidence_transaction_id_payment_transactions_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."payment_transactions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payment_reviews" ADD CONSTRAINT "payment_reviews_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payment_reviews" ADD CONSTRAINT "payment_reviews_shipment_id_shipments_id_fk" FOREIGN KEY ("shipment_id") REFERENCES "public"."shipments"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payment_transactions" ADD CONSTRAINT "payment_transactions_shipment_id_shipments_id_fk" FOREIGN KEY ("shipment_id") REFERENCES "public"."shipments"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payment_transactions" ADD CONSTRAINT "payment_transactions_reversal_fk" FOREIGN KEY ("reverses_transaction_id") REFERENCES "public"."payment_transactions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "payment_evidence_transaction_idx" ON "payment_evidence" USING btree ("transaction_id");--> statement-breakpoint
CREATE UNIQUE INDEX "payment_evidence_source_uq" ON "payment_evidence" USING btree ("source","source_namespace","source_reference","source_line_key");--> statement-breakpoint
CREATE UNIQUE INDEX "payment_evidence_document_uq" ON "payment_evidence" USING btree ("document_hash","source_line_key");--> statement-breakpoint
CREATE INDEX "payment_reviews_order_idx" ON "payment_reviews" USING btree ("order_id","reviewed_at");--> statement-breakpoint
CREATE INDEX "payment_reviews_shipment_idx" ON "payment_reviews" USING btree ("shipment_id","reviewed_at");--> statement-breakpoint
CREATE INDEX "payment_transactions_order_idx" ON "payment_transactions" USING btree ("order_id");--> statement-breakpoint
CREATE INDEX "payment_transactions_shipment_idx" ON "payment_transactions" USING btree ("shipment_id");--> statement-breakpoint
CREATE UNIQUE INDEX "payment_transactions_idempotency_uq" ON "payment_transactions" USING btree ("idempotency_key");--> statement-breakpoint
CREATE UNIQUE INDEX "payment_transactions_reversal_uq" ON "payment_transactions" USING btree ("reverses_transaction_id");--> statement-breakpoint
ALTER TABLE "shipment_events" ADD CONSTRAINT "shipment_events_leg_check" CHECK ("shipment_events"."leg_type" IN ('OUTBOUND', 'RETURN', 'UNKNOWN'));--> statement-breakpoint
ALTER TABLE "shipment_events" ADD CONSTRAINT "shipment_events_verification_check" CHECK ("shipment_events"."verification_status" IN ('PENDING', 'VERIFIED', 'REJECTED', 'DISPUTED'));--> statement-breakpoint
