...
CREATE FUNCTION payment_check_target() RETURNS trigger LANGUAGE plpgsql AS $$
...
FOR EACH ROW EXECUTE FUNCTION payment_check_target();
--> statement-breakpoint
CREATE FUNCTION payment_protect_shipment_link() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
...
--> statement-breakpoint
CREATE FUNCTION payment_transaction_guard() RETURNS trigger LANGUAGE plpgsql AS $$
...
--> statement-breakpoint
CREATE FUNCTION payment_append_only() RETURNS trigger LANGUAGE plpgsql AS $$
...
--> statement-breakpoint
CREATE FUNCTION payment_audit() RETURNS trigger LANGUAGE plpgsql AS $$
...
--> statement-breakpoint
CREATE FUNCTION payment_protect_audit() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
