# Bàn giao · Agent N · Gửi lại tin Lark/Telegram hỏng · Dọn lời duyệt kẹt (migration 0145)
...
| Không "gửi lại" thứ chưa từng định gửi | Chỉ dòng có `notify_attempts ≥ 1`. NULL = dòng trước 0145 / dòng do đường khác tạo / dòng không có kênh ⇒ không bao giờ. Không kênh nào cấu hình ⇒ không nhận dòng (không đốt lượt thử). |
...
**Migration `drizzle/0145_notification_retry.sql`** (journal idx 145, `when` 1790006541389, viết tay, idempotent):
