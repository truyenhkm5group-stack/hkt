...
Nhánh `claude/cos-f-economics` (từ `origin/main` 5a3a7ee6). Migration `0135_company_os_economics`.
...
`lib/queries/production-variance.ts`, `drizzle/0135_company_os_economics.sql`,
