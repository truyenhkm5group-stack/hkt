...
export const MARKETING_METRICS: MarketingMetricSpec[] = [
  ...
  },
  {
    ...
    group: "COST",
    unit: "VND",
    meaning: "Cước vận chuyển của đơn đã gửi, cộng phí hoàn và phí sàn.",
    numerator: null,
    denominator: null,
    source: "orders.partner_fee + orders.return_fee + orders.fee_marketplace (cùng cách bộ máy lợi nhuận cộng)",
    timing: "Theo đơn.",
    nullRule: "0 là 0.",
    direction: "DOWN",
  },
