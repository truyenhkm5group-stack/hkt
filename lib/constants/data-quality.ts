...
export const VERIFIED_OUTCOME_LABEL: Record<VerifiedOutcome, string> = {
  ...
  DELIVERED: "Giao thành công (tiền thực thu > 100K)",
  RETURNED: "Hoàn (tiền thực thu < 50K)",
...
export const DQ_ISSUE_LABEL: Record<DqIssue, string> = {
  ...
  "vtp-low-cash": "Viettel Post báo giao nhưng thực thu < 50K",
...
export const DQ_ISSUE_HINT: Record<DqIssue, string> = {
  ...
  "vtp-low-cash": "Viettel Post ghi 'Giao thành công' cho cả chiều hoàn. Thực thu < 50K nghĩa là khách trả hàng, không phải doanh thu.",
