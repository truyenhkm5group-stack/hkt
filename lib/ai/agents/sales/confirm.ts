...
import { confirmationFingerprint, type SalesState } from "@/lib/ai/agents/sales/state";
import { ORDER_REQUIREMENT_LABEL, type OrderRequirement } from "@/lib/ai/tools/erp";
