...
import { claimTask, finishTask, recordAiError, runsInLastHour } from "@/lib/ai/events";
import { parseRouting, runModelStep, type ModelAttempt } from "@/lib/ai/model-router";
import { getAgent } from "@/lib/ai/registry";
import { startRun, type RunRecorder } from "@/lib/ai/runs";
import { callTool } from "@/lib/ai/tools/gateway";
import { registerErpTools } from "@/lib/ai/tools/erp";
import { checkContextualConfirmation } from "@/lib/ai/agents/sales/confirm";
import { decide, type SalesDecision } from "@/lib/ai/agents/sales/decide";
import { generateSystemPrompt, guardGeneratedText, renderOrderReview, renderTemplate, type GenerationContext } from "@/lib/ai/agents/sales/generate";
